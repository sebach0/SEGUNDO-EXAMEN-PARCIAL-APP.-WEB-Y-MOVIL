-- =========================================================
-- Ciclo 2 — Fase 4 — CU20 Pago del servicio
...
-- Un solo pago exitoso por solicitud (evita doble cobro).
CREATE UNIQUE INDEX IF NOT EXISTS ux_pagos_un_pagado_por_solicitud
    ON pagos (solicitud_id)
    WHERE estado = 'PAGADO';
